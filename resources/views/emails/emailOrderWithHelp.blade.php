...
<body>
	...
	<div class="wrapper">
		<div class="content">
			<h2>Сообщение со страницы клиента, "Покупка с нашей помощью"</h2>

			<h4>E-mail отправителя: {{ $user_email }}</h4>

			<p>Ссылка: {{ $link }}</p>

			<p>Наименование заказа: {{ $name }}</p>

			<p>Артикель №: {{ $article }}</p>

			<p>Цена: {{ $price }} €</p>

			<p>Доставка по Германии: {{ $shipment }} €</p>
