            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="adminMenu">
                        ...
                        <a href="{{ route('adminOrderSelfNew') }}" class="{{ ( Request::is('admin/orderSelfNew')) ? 'adminMenu_class' : ' ' }}">НОВЫЕ</a>
                        ...
                        @if(isset($ordersNew))
                            @foreach($ordersNew as $orderNew)
                                <tr>
                                    ...
                                    <td><a href="{{ route('adminUserProfilOrderSelf',['id' => $orderNew->user->id, 'order_id' => $orderNew->id]) }}">>>> ССЫЛКА НА ПРОФИЛЬ <<<</a></td>
                                </tr>
                            @endforeach
                        @endif
                    </table>
